                    ...
                    <form action="{{ route('user.update', $user->userid) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="useraddress" class="form-control"
                                value="{{ old('useraddress', $user->useraddress) }}" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">User Phone No</label>
                            <input type="text" name="userphno" class="form-control"
                                value="{{ old('userphno', $user->userphno) }}" required>
                        </div>

                        <!-- area to change deptmentname and rolename--> 
