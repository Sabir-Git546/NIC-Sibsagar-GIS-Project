...
Route::middleware(['auth'])->group(function () {
    ...
    */
    Route::middleware('role:1')
        ...
        Route::get('/departments/{deptid}/edit', [DepartmentController::class, 'edit'])->name('department.edit');
        Route::put('/departments/{deptid}', [DepartmentController::class, 'update'])->name('department.update');
        Route::delete('/departments/{deptid}', [DepartmentController::class, 'destroy'])->name('department.destroy');

        // Users
        Route::get('/users', [UserController::class, 'index'])->name('user.index');
        Route::get('/users/create', [UserController::class, 'create'])->name('user.create');
        Route::post('/users', [UserController::class, 'store'])->name('user.store');
        Route::get('/users/{userid}/edit', [UserController::class, 'edit'])->name('user.edit');
        ...
        // District Boundary
        Route::get('/dist-bound', [DistBoundController::class, 'index'])->name('dist-bound.index');
        Route::get('/dist-bound/create', [DistBoundController::class, 'create'])->name('dist-bound.create');
        Route::post('/dist-bound', [DistBoundController::class, 'store'])->name('dist-bound.store');
        Route::get('/dist-bound/{unitid}/edit', [DistBoundController::class, 'edit'])->name('dist-bound.edit');
        Route::put('/dist-bound/{unitid}', [DistBoundController::class, 'update'])->name('dist-bound.update');
        Route::delete('/dist-bound/{unitid}', [DistBoundController::class, 'destroy'])->name('dist-bound.destroy');
    ...
    */
    Route::middleware('role:1,2,3')
        ...
        // FIXED: proper named routes (this solves your error)
